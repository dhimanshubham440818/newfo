...
import { FooterData } from "@/DataFile/data";



export function BackgroundBoxesDemo() {
  const { contactInfo, quickLinks } = FooterData;
  return (
    <div className=" relative w-full overflow-hidden bg-[#090e34] rounded-lg">
      ...
      <Boxes />
      <footer className="ag bg e z relative z-20">
        <div className="a">
          <div className="mb hd ga">
            <div className="bc ek/2 kl/12 df">
              <div className="la">
                ...
                <p className="eh ug lh qa"><a href="/cdn-cgi/l/email-protection" className="__cf_email__"
                  data-cfemail="6c0f00031f091e1c0d0b092c09010d0500420f0301">{contactInfo.email}</a></p>
                <p className="eh ug lh qa">{contactInfo.address}</p>
                <p className="eh ug lh qa">{contactInfo.mobile}</p>
              </div>
            </div>
            <div className="bc ek/2 ll/12 df">
              <div className="la">
                ...
                <ul>
                  <li>
                    <a href="javascript:void(0)" className="lb ug lh ua ui"> The Studio </a>
                  </li>
                  <li>
                    <a href="javascript:void(0)" className="lb ug lh ua ui"> Sponsoring </a>
                  </li>
                  <li>
                    <a href="javascript:void(0)" className="lb ug lh ua ui"> Newsletter </a>
                  </li>
                  <li>
                    <a href="javascript:void(0)" className="lb ug lh ua ui"> Contact Us </a>
                  </li>
                </ul>
              </div>
            </div>
            <div className="bc ek/2 ml/12 df">
              <div className="la">
                ...
                <ul>
                  <li>
                    <a href="javascript:void(0)" className="lb ug lh ua ui"> Hot Stuff </a>
                  </li>
                  <li>
                    <a href="javascript:void(0)" className="lb ug lh ua ui"> Perfect Place </a>
                  </li>
                  <li>
                    <a href="javascript:void(0)" className="lb ug lh ua ui"> Vintage </a>
                  </li>
                  <li>
                    <a href="javascript:void(0)" className="lb ug lh ua ui"> Products </a>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <ul>

                  {
                    quickLinks.map((ele, i) => (
                      <li key={i}>
                        <a href={ele.url} className="lb ug lh ua ui"> {ele.title} </a>
                      </li>
                    ))
                  }
          ...
          <div className="xa cg _d ee ke">
            <div className="mb id kd oa">
              <a href="javascript:void(0)" className="mb id kd gc tb on ha lh ui" aria-label="social-link" name="social-link">
                <svg width="32" height="32" viewBox="0 0 32 32" className="ye" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <p className="eh ug lh sg">All rights reserved by © Portfolio creative 2024</p>
          </div>
        </div>

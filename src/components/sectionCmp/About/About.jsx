import { AboutMeData } from "@/DataFile/data"
import { TextGenerateEffectDemo } from "@/components/aceternityCmp/TextGenerateEffectDemo"
                ...
                <div className="mb hd ca">
                    <div className="bc pl/2 xm/12 df ma bl">
                        ...
                        <h2 className="uc dh jh wg wj kk hh ak qk oa">
                            {AboutMeData.titleHeading}
                        </h2>
                        <div className="sc eh ug lh">
                            <TextGenerateEffectDemo words={AboutMeData.summary} />
                        </div>
                    </div>
                    <div className="bc pl/2 ym/12 df">
                        <h3 className="fh jh yg mk eb">Connect With Me</h3>
                        <p className="eh ug lh la">
                            {AboutMeData.connectWithMeMessage}
                        </p>
                        <div className="mb id">
                            {/* facebook icon  */}
                            <a href="https://www.facebook.com/dhimanshubham440" target="blank" className="fc sb sa td mb id kd xd ge lh ri qi vi" aria-label="social-link"
                                name="social-link">
                            ...
                            {/* twitter  */}
                            <a href="https://x.com/dhimanshubham_1" target="blank"  className="fc sb sa td mb id kd xd ge lh ri qi vi" aria-label="social-link"
                                name="social-link">
                                <svg width="19" height="14" viewBox="0 0 19 14" className="ye">
                                    <path
                            ...
                            {/* youtube  */}
                            {/* <a href="javascript:void(0)" target="blank" className="fc sb sa td mb id kd xd ge lh ri qi vi" aria-label="social-link"
                                name="social-link">
                                <svg width="19" height="14" viewBox="0 0 19 14" className="ye">
                                    <path
                            ...
                            {/* linkedin */}
                            <a href="https://www.linkedin.com/in/shubham-dhiman-751b00279/" target="blank" className="fc sb sa td mb id kd xd ge lh ri qi vi" aria-label="social-link"
                                name="social-link">
                                <svg width="14" height="14" viewBox="0 0 14 14" className="ye">
                                    <path

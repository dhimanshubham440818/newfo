            ...
            <div class="a">
                <div class="mb hd ca">
                    ...
                    <div class="bc pl/2 ym/12 df">
                        ...
                        <div class="mb id">
                            {/* facebook icon  */}
                            <a href="https://www.facebook.com/dhimanshubham440" target="blank" class="fc sb sa td mb id kd xd ge lh ri qi vi" aria-label="social-link"
                                name="social-link">
                            ...
                            {/* twitter  */}
                            <a href="https://x.com/dhimanshubham_1" target="blank"  class="fc sb sa td mb id kd xd ge lh ri qi vi" aria-label="social-link"
                                name="social-link">
                            ...
                            {/* youtube  */}
                            {/* <a href="javascript:void(0)" target="blank" class="fc sb sa td mb id kd xd ge lh ri qi vi" aria-label="social-link"
                                name="social-link">
                                <svg width="19" height="14" viewBox="0 0 19 14" class="ye">
                                    <path
                            ...
                            {/* linkedin */}
                            <a href="https://www.linkedin.com/in/shubham-dhiman-751b00279/" target="blank" class="fc sb sa td mb id kd xd ge lh ri qi vi" aria-label="social-link"
                                name="social-link">

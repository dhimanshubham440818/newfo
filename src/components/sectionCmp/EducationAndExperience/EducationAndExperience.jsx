                        ...
                        <div class="mb hd ga">
                            <div class="bc pl/2 df">
                                <div class="tl an bc ib mg uj em gm cl im e bg">
                                    ...
                                    <h3 class="fh zg jh qa">UI/UX Designer</h3>
                                    <p class="fh ug lh ua">Google INC | New York</p>
                                    <span class="nb id kd if df td pe kh ah fh oa"> 2011 - 2013 </span>
                                    <p class="eh ug lh">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm tempor incididunt ut labore et
                                        dolore magna aliqua Loremipsum dolor sit amet, consectetur adipisicing elit.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="bc pl/2 df">
                                <div class="tl an bc mg uj em dl e bg">
                                    ...
                                    <h3 class="fh zg jh qa">Specialization Course</h3>
                                    <p class="fh ug lh ua">Stanford University | New York</p>
                                    <span class="nb id kd if df td pe kh ah fh oa"> 2017 - 2018 </span>
                                    <p class="eh ug lh">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm tempor incididunt ut labore et
                                        dolore magna aliqua Loremipsum dolor sit amet, consectetur adipisicing elit.
                                    </p>
                            ...
                            <div class="bc pl/2 df">
                                <div class="tl an bc ib mg uj em gm cl im e bg">
                                    <span class="d i g wk xk mc yb td oe yd he"></span>
                                    <h3 class="fh zg jh qa">Web Designer</h3>
                                    <p class="fh ug lh ua">Facebook INC | New York</p>
                                    <span class="nb id kd if df td pe kh ah fh oa"> 2014 - 2016 </span>
                                    <p class="eh ug lh">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm tempor incididunt ut labore et
                                        dolore magna aliqua Loremipsum dolor sit amet, consectetur adipisicing elit.
                                    </p>
                            ...
                            <div class="bc pl/2 df">
                                <div class="tl an bc mg uj em dl e bg">
                                    <span class="d i g yk mc yb td oe yd he"></span>
                                    <h3 class="fh zg jh qa">Bachelor Degree</h3>
                                    <p class="fh ug lh ua">Stanford University | New York</p>
                                    <span class="nb id kd if df td pe kh ah fh oa"> 2019 - 2021 </span>
                                    <p class="eh ug lh">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm tempor incididunt ut labore et
                                        dolore magna aliqua Loremipsum dolor sit amet, consectetur adipisicing elit.
                                    </p>

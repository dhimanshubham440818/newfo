import { ExperiencData } from "@/DataFile/data"

export default function Experience() {
    return (
        <section id="experience" className="ig oe  e z">
            <div className="a">
                <div className="zd de jg">
                    <div className="mb hd ca">
                        <div className="bc df">
                            <div className="vc fa sg gb">
                                <span className="fh _g mh kb ta"> {ExperiencData.sectionName} </span>
                                <h2 className="dh jh wg wj kk oa">{ ExperiencData.title }</h2>
                                <p className="eh _g lh">
                                    {ExperiencData.summary}
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="e cg">
                        ...
                        <div className="mb hd ga">
                            {
                                ExperiencData.experience_journey.map((ele, index) => (
                                    index % 2 == 0 ?
                                        <>

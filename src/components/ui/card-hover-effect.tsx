        ...
        >
          ...
          <Card>
            ...
            <div className="oe dj ri wh of lf ud e z od sg di">
              ...
              <h3 className="dh jh zg yj km 2xl:ud-text-2xl hj ua">{item.title}</h3>
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full  overflow-hidden bg-white border border-transparent dark:border-white/[0.2] group-hover:border-white relative z-20",
        className
      )}
    >
